...
while(keepTrying):
    ...
    driver.get('https://www.decathlon.es/es/p/barra-de-musculacion-domyos-de-2-m-y-28-mm/_/R-p-9291?mc=8289900')
    ...
    try:
        ...
        if(clickCart == True and element.is_displayed() == True):
            bot.send_message(77771278, "https://www.decathlon.es/es/p/barra-de-musculacion-domyos-de-2-m-y-28-mm/_/R-p-9291?mc=8289900")
